...
1) Out of individuals who are actually extremely poor, we successfully predict about 2.2% of the times. The model does not perform very well in terms of this metric: Out of 7.9% people who are actually extremely poor, we only predicted 2.2% of them correctly.

2) Out of all the individuals that we predict to be extremely poor, 41.6% are actually extreme poor. 


For the prediction of non vulnerable households, The model has a sensitivity of 95.66%. This suggests that out of people who are non vulnerable, we correctly predict 95.66% of the time. In the validation set, 62.8% of the people are non vulnerable. So our predictions is pretty good. This would efficiently help the bank to avoid providing money to people who are non vulnerable and who do not necessarily need the money. 
