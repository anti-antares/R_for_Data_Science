...
poverty_rf=poverty %>% select(-v2a1,-v18q1,-rez_esc,-Id,-idhogar,-dependency) %>% mutate(SQBmeaned=impute.mean(SQBmeaned),
...
rf_fit2 <- train(Target ~ ., data = poverty_rf, method = "rf", metric = "Accuracy",
...
poverty_test=poverty_test%>% select(-v2a1,-v18q1,-rez_esc,-idhogar,-dependency) %>% mutate(SQBmeaned=impute.mean(SQBmeaned),
                                                                                         meaneduc=impute.mean(meaneduc))
